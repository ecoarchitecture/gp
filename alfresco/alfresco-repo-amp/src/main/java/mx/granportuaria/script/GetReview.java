 ...
 * 
 */
package mx.granportuaria.script;
...
import mx.granportuaria.model.GranportuariaWorkflowModel;
...
public class GetReview extends DeclarativeWebScript {
	 ...
	 Log logger = LogFactory.getLog(GetReview.class);
	    ...
	    protected Map<String, Object> executeImpl(WebScriptRequest req, Status status) {
	        ...
	        props.put(QName.createQName(GranportuariaWorkflowModel.NAMESPACE_SOMECO_WORKFLOW_CONTENT_MODEL, GranportuariaWorkflowModel.PROP_APPROVE_REJECT_OUTCOME), action);
